...
import { Bell, Building2, CheckCheck, ClipboardList, LogOut, Menu, Settings2, ShieldCheck, Stethoscope, UsersRound, X } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[#f6f9f8]" style={{ "--app-accent": presentation.data?.accentColor ?? "#0f766e" } as React.CSSProperties}>
