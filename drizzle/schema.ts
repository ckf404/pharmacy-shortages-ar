...
export const appSettings = mysqlTable("app_settings", {
  ...
  pharmacyName: varchar("pharmacyName", { length: 160 }).notNull().default("الصيدلية"),
  pharmacyPhone: varchar("pharmacyPhone", { length: 32 }),
  pharmacyAddress: varchar("pharmacyAddress", { length: 255 }),
  supplierMessageIntro: varchar("supplierMessageIntro", { length: 300 }).notNull().default("طلب نواقص من {pharmacyName} — {date}"),
  supplierMessageFooter: varchar("supplierMessageFooter", { length: 300 }).notNull().default("برجاء تأكيد التوفر وموعد التسليم. شكرًا."),
  ...
  showDashboardStats: boolean("showDashboardStats").notNull().default(true),
  showShortageForm: boolean("showShortageForm").notNull().default(true),
  showPriorityPicker: boolean("showPriorityPicker").notNull().default(true),
  showSupplierPicker: boolean("showSupplierPicker").notNull().default(true),
  showNotesField: boolean("showNotesField").notNull().default(true),
  showInvoiceArchive: boolean("showInvoiceArchive").notNull().default(true),
  enabledDosageForms: text("enabledDosageForms"),
  quantityPresets: varchar("quantityPresets", { length: 64 }).notNull().default("1,2,3,4"),
